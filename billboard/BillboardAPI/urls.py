...
urlpatterns = [
    ...
    path('mod/auto_mod_terms/', views.get_auto_mod_terms, name='get-auto-mod-terms'),
    path('mod/users/add', views.add_user, name='add-user'),
    path('mod/auto_mod_terms/add/', views.add_disallowed_phrase, name='add-disallowed-phrase'),
    ...
    path("mod/auto_mod_terms/update/<int:id>/", views.update_auto_mod_term, name="update-auto-mod-term"),
    path("mod/auto_mod_terms/delete/<int:id>/", views.delete_auto_mod_term, name="delete-auto-mod-term"),
